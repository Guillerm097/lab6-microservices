...
![image 1](img/1.png "All services deployed")
---
We can check that both microservices have been registered in Eureka
![image 2](img/2.png "Microservices registered in Eureka")
---
We add another microservice account instance running on port 4444
![image 3](img/3.png "2 account microservices registered in Eureka")
---
...
![image 4](img/4.png "Microservice 4444 working") 